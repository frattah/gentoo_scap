...
var_nftables_base_chain_names='(bash-populate var_nftables_base_chain_names)'

#Type(s) of base chain
var_nftables_base_chain_types='(bash-populate var_nftables_base_chain_types)'

# Hooks for base chain
var_nftables_base_chain_hooks='(bash-populate var_nftables_base_chain_hooks)'

#Priority
var_nftables_base_chain_priorities='(bash-populate var_nftables_base_chain_priorities)'

#Policy 
var_nftables_base_chain_policies='(bash-populate var_nftables_base_chain_policies)'
